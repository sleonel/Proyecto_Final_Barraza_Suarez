 ...
 * and the structure of the message that is sent to the L2 node with
 * the information about the local time (time stamp) at which the TPSN request 
 * was received.
 * 
 * TPSN request to L0 message module of the TPSN protocol
 * TPSN receive form L0 (report message) module of the TPSN protocol
 * and the structure of the message that is sent to the L0 node with
 * the information about the local time (time stamp) at which the TPSN request 
 * was received.
 * 
 * 
...
enum {
  ...
  Tpsn1_MSG = 144,   // TPSN request to Base node type 144=0x90
  TPSN1_REPORT_MSG = 147, // TPSN report to L2
...
typedef nx_struct Tpsn1_ReportMsg {
  ...
  nx_uint16_t Tpsn2SeqNr; // TPSN report sequence number
